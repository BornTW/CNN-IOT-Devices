...
def draw_roc(predicted, Y_test):
    ...
    plt.subplots_adjust(left=0.08, right=0.65)
    plt.show()
...
def visual_cm(cm):
    ...
    sn.heatmap(df_cm, annot=True, annot_kws={"size": 9},cmap="Blues")  # font size
    plt.show()
...
def visual_model(model, input_shape):
